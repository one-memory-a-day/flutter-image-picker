...
#
Pod::Spec.new do |s|
  s.name             = 'flutter_image_picker_ios'
  s.version          = '1.0.1'
...
Downloaded by pub (not CocoaPods).
                       DESC
  s.homepage         = 'https://github.com/one-memory-a-day/flutter-image-picker'
  s.license          = { :type => 'BSD', :file => '../LICENSE' }
  s.author           = { 'Flutter Dev Team' => 'flutter-dev@googlegroups.com' }
  s.source           = { :http => 'https://github.com/one-memory-a-day/flutter-image-picker/tree/main/image_picker_ios' }
  s.documentation_url = 'https://pub.dev/packages/flutter_image_picker_ios'
